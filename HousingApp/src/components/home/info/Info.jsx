  ...
  return (
    <section className="info padding">
      <div className="container">
        ...
        <Heading
          title="επενδύστε στο αύριο"
          subtitle="∆εν είναι απλή αγορά ακινήτου είναι επένδυση"
        />
        <div className={`row ${isMobile ? "" : "g-5"} align-items-center`}>
          <div
            className="col-lg-6"
            data-aos="fade-up"
            data-aos-delay="100"
          ...
          <div
            className="col-lg-6 info-text"
            data-aos={isMobile ? "fade-in" : "fade-up"}
            data-aos-delay="600"
            data-aos-once="true">
            <p>
              H <b>Domus Alba</b> είναι μία νέα εταιρεία που έρχεται να
              επαναπροσδιορίσει το τι σημαίνει αγορά ακινήτου, κατοικίας ή
              διαμερίσματος: σημαίνει επένδυση.
              <b>"Domus alba"</b> θα πει <b>«Λευκός οίκος»</b>. Θα πει ότι εκεί
              όπου σήμερα άλλοι δεν βλέπουν τίποτα, στην <b>Domus Alba</b>{" "}
              βλέπουμε τρόπους να επενδύσουμε στο αύριο. Αξιοποιώντας ό,τι πιο
              καινοτόμο έχει να προσφέρει η αγορά ακινήτων, είτε πρόκειται για
              ιδιοκατοίκηση είτε για αξιοποίηση και εκμετάλλευση ακινήτου,
              προσφέρουμε ολοκληρωμένες προτάσεις και εξειδικευμένες λύσεις για
          ...
          <div
            ...
            <div className="card d-flex align-items-center flex-column">
              ...
              <div className="info-box-text">
                <h5>Kαινοτομία</h5>
                <p>
                  Διαρκής δέσμευση στην καινοτομία και ανάπτυξη ακινήτων στην
                  Κύπρο. Η αφοσίωσή μας στην καινοτομία διαμορφώνει την ανάπτυξη
                  ακινήτων στην Κύπρο.
                  <br />
                  Παρακολουθούμε και προβλέπουμε τις τάσεις στην αγορά για να
                  βρισκόμαστε στην επικράτεια της καινοτομίας στον χώρο των
                  ακινήτων
                </p>
              </div>
            </div>
            ...
            <div className="card -flex align-items-center flex-column">
              ...
              <div className="info-box-text">
                ...
                <p>
                  ...
                  Λόγω των ιδιαίτερων και μοναδικών χαρακτηριστικών της διοίκησης της εταιρείας, η <b>Domus Alba Ltd</b>, είναι σε θέση να προσφέρει την <b>BEST VALUE FOR MONEY</b> επιλογή στον τομέα της αγοράς και επένδυσης/διαχείρισης ακινήτων.
                  Τα έργα μας αντιπροσωπεύουν επιτυχημένα, ανθεκτικά σχέδια
                  κτιρίων και υψηλή ποιότητα
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="card d-flex align-items-center flex-column">
              ...
              <div className="info-box-text">
                <h5>Συνεργασίες</h5>
                <p>
                  Ισχυρές συνεργασίες στον κλάδο με διακεκριμένους αρχιτέκτονες παρέχουν την απαραίτητη εμπειρογνωμοσύνη και δημιουργικότητα για εξαιρετικά αποτελέσματα. Συνεργασίες βασισμένες στην αμοιβαία εμπιστοσύνη και στη συνεχή ανταλλαγή ιδεών, ενθαρρύνοντας την καινοτομία και την αριστεία σε κάθε στάδιο του έργου
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            <div className="card d-flex align-items-center flex-column">
              ...
              <div className="info-box-text ">
                ...
                <h5>Συγκριτικό Πλεονέκτημα</h5>
                <p>
                  Άμεσα μεταβιβάσιμα με την υπογραφή αγοραπωλητήριου εγγράφου
                  <br />
                  Έκδοση διατακτικών πληρωμών προς τραπεζικά ιδρύματα <i>(Σε περιπτώσεις που τα έργα προαγοράζονται)</i>
                  <br />
                  Καμία οικονομική υποχρέωση υποθήκη στο ακίνητο
                </p>
              </div>
            </div>
          </div>
