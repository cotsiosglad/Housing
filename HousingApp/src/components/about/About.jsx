          ...
          <div className='about-content container mtop' >
            <div className='row'>
              <div className="col-md-6 about-content-text">
                ...
                <p>
                  Το όραμά μας στην Domus Alba είναι ένα: με την πολυετή
                  ...
                  γιατί... αγορά ακινήτου σημαίνει επένδυση!Όσον αφορά τα έργα
                  της εταιρείας, όλα γίνονται με ίδια κεφάλαια και είναι άμεσα
                  μεταβιβάσιμα με την υπογραφή του αγοραπωλητήριου εγγράφου.
                  Επιπλέον, κανένα έργο δεν έχει εμπράγματο βάρος, συνεπώς καμία
                  υποθήκη.
                </p>
              </div>
              <div
