          ...
          <img src={background} alt='' />
                ...
                <div className=" row">
                    <div className='col-12 project-img'>
                        <img src={projectMainImage ? projectMainImage[0].files[0].objectURL : "../images/no_image.jpg"} alt={projectMainImage ? projectMainImage[0].files[0].name : ''}></img>
                ...
                <div className='row mt-4'>
                    ...
                    <div className='col-4'>
                        <div className='project-info-card'>
                            ...
                            <img src={projectSideImage ? projectSideImage[0].files[0].objectURL : "../images/no_image.jpg"} alt={projectSideImage ? projectSideImage[0].files[0].name : ''}></img>
                        </div>
                    </div>
                </div>
                <div className='row'>
                ...
                <img src={val} alt="" key={index} onClick={() => setToggler(!toggler)}/>
                            ...
                            <div className='project-details-card'>
                                <ImageCarousel imageList={currProjectImages} />
                                {/* <ImageViewer imageList={project.images} /> */}
                            </div>
